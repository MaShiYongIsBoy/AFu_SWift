//
//  AFMedicineChildControllerA.swift
//  AFu_Swift
//
...
class AFMedicineChildControllerA: UIViewController {
...
///MARK - UItableView 代理
extension AFMedicineChildControllerA:UITableViewDelegate,UITableViewDataSource{
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCellWithIdentifier("ChildTableCellA") as! ChildTableCellA
