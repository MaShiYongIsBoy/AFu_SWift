//
//  AFMedicineChildControllerB.swift
//  AFu_Swift
//
...
class AFMedicineChildControllerB: UIViewController {
...
///MARK - UItableView 代理
extension AFMedicineChildControllerB:UITableViewDataSource,UITableViewDelegate{
    func tableView(tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return json["data"]["items"][0]["items"].count
    }
    
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCellWithIdentifier("ChildTableCellB") as!ChildTableCellB
         cell.titleNameLabel.text = "\(json["data"]["items"][0]["items"][indexPath.row]["title"])"
        return cell
    }
