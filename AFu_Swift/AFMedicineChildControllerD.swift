//
//  AFMedicineChildControllerD.swift
//  AFu_Swift
//
...
class AFMedicineChildControllerD: UIViewController {
...
///MARK - UItableView 代理
extension AFMedicineChildControllerD:UITableViewDataSource,UITableViewDelegate{
    func tableView(tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return json["data"]["items"][2]["items"].count
    }
    
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCellWithIdentifier("ChildTableCellD") as!ChildTableCellD
         cell.titleNameLabel.text = "\(json["data"]["items"][2]["items"][indexPath.row]["title"])"
        return cell
    }
